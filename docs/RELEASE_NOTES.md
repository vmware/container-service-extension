...
* Fixed master node creation bug

**Documentation:**

* Added list of minimum required user rights for a CSE Service account
...
Replaced with 1.2.4 due to bug with master node creation.
...
* Fix SSL support for vCenter 6.7 (#135)
...
* Fix bug regarding installation of CSE data files via PyPI for Windows systems
* Fix AMQP exchange not created bug

**Documentation:**

* Updated CSE main documentation (#132)
* Updated docstrings for commands (#133)
...
* Add safeguards to file reading (#102)
* Force users to provide vCenter service account (#91)
* Add --ssh-key option for cse install (#114)
* Restrict permissions when setting up iptables-ports service (#103)

**Usability Improvements and Bug Fixes:**

* Fix AMQP settings display
* Skip AMQP configuration if current vcd settings are same as config file
* Fix ubuntu customization script
* Always share templates catalog during cse installation
* Minor bug fixes
...
* Privileges required for VCD service account & CSE-VCD compatibility matrix (#109)
