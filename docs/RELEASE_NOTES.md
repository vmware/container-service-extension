...
* Fixed bug where control_plane node creation fails during cluster create command.
...
Replaced with 1.2.4 due to bug where control_plane node creation fails during cluster create command.
