...
```sh
# create cluster mycluster with one control_plane and two nodes, connected to provided network
...
# create cluster mycluster with one control_plane, three nodes and connected to provided network
...
# create cluster mycluster with one control_plane, three worker nodes, connected to provided network
