...
apt-get -q install -y kubelet=1.13.4-00 kubeadm=1.13.4-00 kubectl=1.13.4-00 kubernetes-cni=0.6.0-00 --allow-unauthenticated
apt-get -q autoremove -y
systemctl restart docker
while [ `systemctl is-active docker` != 'active' ]; do echo 'waiting for docker'; sleep 5; done

echo 'downloading container images'
docker pull k8s.gcr.io/kube-apiserver-amd64:v1.13.4
docker pull k8s.gcr.io/kube-controller-manager-amd64:v1.13.4
docker pull k8s.gcr.io/kube-proxy-amd64:v1.13.4
docker pull k8s.gcr.io/kube-scheduler-amd64:v1.13.4
