...
def create_or_update_task(task, description, cluster_name, cluster_id,
                          status, provisioner, task_id=None):
    namespace = 'cpsbu.cse'
    ...
    t = task.create_or_update_task(status, namespace, operation_name,
                                   operation_description, owner_href,
                                   owner_name, owner_type, user_id,
                                   user_name, progress, org_id=org_id,
                                   task_id=task_id)
    return t
