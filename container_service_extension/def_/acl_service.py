...
def get_all_def_ent_acl(cloudapi_client, de_id):
    ...
    """
    access_controls_path = f'{cloudapi_constants.CloudApiResource.ENTITIES}/' \
                           f'{de_id}/{cloudapi_constants.CloudApiResource.ACL}'
    user_acl_info = {}
...
def get_access_level_from_urn(access_level_urn):
    if access_level_urn.startswith(cloudapi_constants.CloudApiResource.ACCESS_LEVEL_URN_BEGIN):  # noqa: E501
        return access_level_urn.split(cloudapi_constants.CloudApiResource.ACCESS_LEVEL_URN_BEGIN)[-1]  # noqa: E501
    return None
