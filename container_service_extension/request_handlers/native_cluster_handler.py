...
def cluster_create(request_data, security_ctx: ctx.SecurityContext):
    ...
    :return: Dict
    """
    vcd_broker = VcdBroker(security_ctx)
...
def cluster_upgrade_plan(request_data, security_ctx: ctx.SecurityContext):
...
def cluster_upgrade(request_data, security_ctx: ctx.SecurityContext):
