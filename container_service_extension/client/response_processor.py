...
def response_to_exception(response):
    ...
    if not response:
        pass
    elif response.status_code == requests.codes.gateway_timeout:
        error_message = 'Unable to communicate with CSE Server.'
    elif response.status_code in (requests.codes.unauthorized, requests.codes.forbidden): # noqa: E501
