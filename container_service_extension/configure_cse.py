...
from container_service_extension.utils import yaml_file_to_dict
...
def generate_sample_config(output=None, pks_output=None):
    ...
    :rtype: dict
    """
    sample_config = TEMPLATE_CONFIG_KEY_NOTE + '\n'
...
def get_validated_config(config_file_name):
    ...
    config = yaml_file_to_dict(config_file_name)
    ...
    if isinstance(pks_config_location, str):
        ...
        pks_config = yaml_file_to_dict(pks_config_location)
...
def validate_broker_config(broker_dict):
    ...
    template_config_dict = yaml_file_to_dict(
