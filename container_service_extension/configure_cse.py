...
def install_cse(config_file_name, skip_template_creation, force_update,
                ssh_key, retain_temp_vapp, pks_config_filename=None,
    ...
    :param str pks_config_filename: pks config file name.
    ...
    config = get_validated_config(
        config_file_name, pks_config_filename=pks_config_filename,
