...
class CseOperation(Enum):
    ...
    V35_CLUSTER_CONFIG = ('get config of cluster')
    V35_CLUSTER_CREATE = ('create cluster', requests.codes.accepted)
    V35_CLUSTER_DELETE = ('delete cluster', requests.codes.accepted)
    V35_CLUSTER_INFO = ('get info of cluster')
    V35_CLUSTER_LIST = ('list clusters')
    V35_CLUSTER_RESIZE = ('resize cluster', requests.codes.accepted)
    V35_CLUSTER_UPGRADE_PLAN = ('get supported cluster upgrade paths')
    V35_CLUSTER_UPGRADE = ('upgrade cluster software', requests.codes.accepted)
    V35_NODE_CREATE = ('create node', requests.codes.accepted)
    V35_NODE_DELETE = ('delete node', requests.codes.accepted)
    V35_NODE_INFO = ('get info of node')
