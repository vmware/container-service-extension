...
class ComputePolicyManager:
    ...
    def __init__(self, vcd_uri, tenant_auth_token, verify_ssl,
        ...
        :param str base_url: base_url to create client
    ...
    def add_policy(self, policy_name, description=None):
        ...
        created_policy = self.cloud_api_client.do_request(
            ...
            payload=policy_info)
        created_policy['display_name'] = self._restore_original_policy_name(
            created_policy['name'])
    ...
    def update_policy(self, policy_name, new_policy_info):
        ...
        if policy_info and new_policy_info.get('name'):
            ...
            updated_policy['display_name'] = \
                self._restore_original_policy_name(updated_policy['name'])
    ...
    def add_compute_policy_to_vdc(self, org_name, vdc_name, policy_href):
        ...
        """
        org = Org(self._vcd_client,
                  resource=self._vcd_client.get_org_by_name(org_name))
        vdc = VDC(self._vcd_client,
                  resource=org.get_vdc(vdc_name, is_admin_operation=True))
        vdc.add_compute_policy(policy_href)
    ...
    def remove_compute_policy_from_vdc(self, org_name, vdc_name, policy_href):
        ...
        vdc = VDC(self._vcd_client,
                  resource=org.get_vdc(vdc_name, is_admin_operation=True))
        vdc.remove_compute_policy(policy_href)
    ...
    def assign_compute_policy_to_vapp_template_vms(self,
        ...
        org = Org(self._vcd_client,
                  resource=self._vcd_client.get_org_by_name(org_name))
        org.assign_compute_policy_to_vapp_template_vms(catalog_name,
                                                       catalog_item_name,
                                                       compute_policy_href)
    ...
    def remove_compute_policy_from_vapp_template_vms(self,
        ...
        org = Org(self._vcd_client,
                  resource=self._vcd_client.get_org_by_name(org_name))
        org.remove_compute_policy_from_vapp_template_vms(catalog_name,
                                                         catalog_item_name,
                                                         compute_policy_href)
