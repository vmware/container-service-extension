...
class PksBroker(AbstractBroker):
    ...
    def list_plans(self):
        ...
        SERVER_PKS_WIRE_LOGGER.debug(f"Sending request to PKS: {self.pks_host_uri} " # noqa: E501
    ...
    def _list_clusters(self):
        ...
        SERVER_PKS_WIRE_LOGGER.debug(f"Received response from PKS: {self.pks_host_uri} on the" # noqa: E501
    ...
    def _create_cluster(self, *args,
        ...
        SERVER_PKS_WIRE_LOGGER.debug(f"Sending request to PKS: {self.pks_host_uri} to create " # noqa: E501
        ...
        SERVER_PKS_WIRE_LOGGER.debug(f"PKS: {self.pks_host_uri} accepted the request to create" # noqa: E501
    ...
    def _get_cluster_info(self, cluster_name):
        ...
        SERVER_PKS_WIRE_LOGGER.debug(f"Sending request to PKS: {self.pks_host_uri} to get " # noqa: E501
                                     f"details of cluster with name: {cluster_name}") # noqa: E501
        try:
        ...
        SERVER_PKS_WIRE_LOGGER.debug(f"Received response from PKS: {self.pks_host_uri} on " # noqa: E501
                                     f"cluster: {cluster_name} with details: {cluster_dict}") # noqa: E501
    ...
    def get_cluster_config(self, **kwargs):
        ...
        SERVER_PKS_WIRE_LOGGER.debug(f"Sending request to PKS: {self.pks_host_uri} to get" # noqa: E501
                                     f" detailed configuration of"
                                     f" cluster with name: {cluster_name}")
        config = cluster_api.create_user(cluster_name=qualified_cluster_name)
        SERVER_PKS_WIRE_LOGGER.debug(f"Received response from"
                                     f" PKS: {self.pks_host_uri} on"
                                     f" cluster: {cluster_name} with details:"
                                     f" {config}")
    ...
    def delete_cluster(self, **kwargs):
        ...
        result = {}
        cluster_api = ClusterApiV1(api_client=self.client_v1)
        SERVER_PKS_WIRE_LOGGER.debug(f"Sending request to"
        ...
        try:
            ...
            LOGGER.debug(f"Deleting cluster {qualified_cluster_name} failed"
                         f" with error:\n {err}")
            raise PksServerError(err.status, err.body)
        SERVER_PKS_WIRE_LOGGER.debug(f"PKS: {self.pks_host_uri} accepted"
    ...
    def resize_cluster(self, **kwargs):
        ...
        try:
            ...
            LOGGER.debug(f"Resizing cluster {qualified_cluster_name} failed"
                         f" with error:\n {err}")
            raise PksServerError(err.status, err.body)
        SERVER_PKS_WIRE_LOGGER.debug(f"PKS: {self.pks_host_uri} accepted the"
    ...
    def create_compute_profile(self, cp_name, az_name, description, cpi,
        ...
        SERVER_PKS_WIRE_LOGGER.debug(f"PKS: {self.pks_host_uri} created the"
                                     f" compute profile: {cp_name}"
                                     f" for ovdc {ovdc_rp_name}")
        return result
    ...
    def list_compute_profiles(self):
        ...
        SERVER_PKS_WIRE_LOGGER.debug(f"Sending request to PKS:"
        ...
        SERVER_PKS_WIRE_LOGGER.debug(f"Received response from PKS:"
