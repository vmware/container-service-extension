...
class PKSBroker(AbstractBroker):
    ...
    @staticmethod
    def get_truncated_cluster_info(cluster, cluster_property_keys):
        ...
        if pks_cluster['vdc_id'] and pks_cluster['vdc']:
            pks_cluster['org_name'] = get_org_by_vdc_href(pks_cluster['vdc_id'], pks_cluster['vdc'])
        return pks_cluster
