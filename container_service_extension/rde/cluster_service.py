...
from container_service_extension.common.constants.server_constants import K8SScriptFile, TemplateScriptFile  # noqa: E501
...
from container_service_extension.common.utils.script_utils import get_k8s_package_file_contents # noqa: E501
...
def _init_cluster(sysadmin_client: vcd_client.Client, vapp, k8s_version,
    ...
    try:
        templated_script = get_k8s_package_file_contents(
            K8SScriptFile.CONTROL_PLANE)
...
def _join_cluster(sysadmin_client: vcd_client.Client, vapp, template_name,
    ...
    try:
        ...
        templated_script = get_k8s_package_file_contents(K8SScriptFile.NODE)
        script = templated_script.format(
            ip_port=join_info[2],
            token=join_info[4],
