...
class ClusterService(abstract_broker.AbstractBroker):
    ...
    def create_cluster(self, entity_id: str, input_native_entity: rde_2_0_0.NativeEntity):  # noqa: E501
        ...
        **telemetry: Optional
        ...
        if not input_native_entity.spec.k8_distribution.template_name and \
            ...
            input_native_entity.spec.k8_distribution = rde_2_0_0.Distribution(
    ...
    def resize_cluster(self, cluster_id: str,
        ...
        self._update_task(vcd_client.TaskStatus.RUNNING, message=msg)
        curr_native_entity.task_href = self.task_resource.get('href')
    ...
    def upgrade_cluster(self, cluster_id: str,
        ...
        cur_native_entity.status.task_href = self.task_resource.get('href')
        try:
            curr_entity = self.entity_svc.update_entity(cluster_id, curr_entity)  # noqa: E501
        except Exception as err:
            self._update_task(vcd_client.TaskStatus.ERROR,
