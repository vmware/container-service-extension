...
from container_service_extension.rde.models import DefEntity
from container_service_extension.rde.models import DefEntityType
from container_service_extension.rde.models import GenericClusterEntity
