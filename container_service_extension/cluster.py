        ...
        if hasattr(record, 'Metadata'):
            for me in record.Metadata.MetadataEntry:
                if me.Key == 'cse.cluster.id':
                    cluster['cluster_id'] = str(me.TypedValue.Value)
                elif me.Key == 'cse.version':
                    cluster['cse_version'] = str(me.TypedValue.Value)
                elif me.Key == 'cse.master.ip':
                    cluster['leader_endpoint'] = str(me.TypedValue.Value)
                elif me.Key == 'cse.template':
                    cluster['template'] = str(me.TypedValue.Value)
